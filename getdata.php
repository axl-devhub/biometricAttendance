    ...
    if (!mysqli_stmt_prepare($result, $sql)) {
        ...
        //New Fingerprint has been added
            ...
            if (!mysqli_stmt_prepare($result, $sql)) {
                ...
                mysqli_stmt_execute($result);
                $sql = "INSERT INTO users ( username, serialnumber, gender, email, fingerprint_id, fingerprint_select, user_date, add_fingerid) VALUES (?, ?, ?, ?, ?, 1, CURDATE(), 0)";
                $result = mysqli_stmt_init($conn);
                if (!mysqli_stmt_prepare($result, $sql)) {
                    ...
                    mysqli_stmt_bind_param($result, "sdssi", $Uname, $Number, $Gender, $Email, $fingerID);
                    mysqli_stmt_execute($result);
